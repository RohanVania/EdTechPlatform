    ...
    <>
      ...
      <div id='section1' className='tw-bg-red-20 tw-bg-richblue-800 '>
        ...
        <div className='tw-px-3 tw-w-11/12   tw-mx-auto '>
          ...
          {/* Code Blocks */}
            <div className=' tw-bg-red-30 tw-mt-[15px] md:tw-mt-[50px] tw-flex tw-flex-col tw-gap-9 tw-pb-[40px] xs:tw-pb-[50px] md:tw-pb-[65px] '>
              <CodeBlock
              btnobj={btndata1}
            ...
            <div className='tw-mx-auto'>
              <div className=' btnalign:tw-text-center tw-pb-[20px] 3xs:tw-pb-[25px]  sm:tw-pb-[50px]'>
                    <HighlightText text="Unlock the" highlight="Power of Code"  Size="300px"/>
      ...
      <div id='section2' className='tw-max-w-maxContent'>
        sidisdis
      </div>
