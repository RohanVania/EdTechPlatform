        ...
        <form  className='tw-flex tw-flex-col tw-gap-y-7'>
            <div className='tw-grid tw-grid-cols-1 btnalign:tw-grid-cols-2 tw-gap-y-6 tw-gap-x-6 tw-justify-center '>
                <div className='tw-flex tw-flex-col tw-gap-y-2'>
                    ...
                    <input type='text' id='firstname' placeholder='Enter first name' className=' tw-p-[12px] tw-rounded-[8px] tw-shadow-sm tw-shadow-[#ffffffd9] tw-bg-richblack-800 tw-text-[16px] tw-text-richblack-200 tw-outline-none ' />
                </div>
                <div className='tw-flex tw-flex-col tw-gap-y-2'>
                    ...
                    <input type='text' id='lastname' placeholder='Enter Last name' className=' tw-p-[12px] tw-rounded-[8px] tw-shadow-sm tw-shadow-[#ffffffd9] tw-bg-richblack-800 tw-text-[16px] tw-text-richblack-200 tw-outline-none ' />
                </div>
            </div>
            <div className='tw-flex tw-flex-col tw-gap-y-3'>
                ...
                <input type='email' id='email' placeholder='Enter email address' className=' tw-p-[12px] tw-rounded-[8px] tw-shadow-sm tw-shadow-[#ffffffd9] tw-bg-richblack-800 tw-text-[16px] tw-text-richblack-200 tw-outline-none ' />
            </div>
            <div className='tw-flex tw-flex-col tw-gap-y-3'>
                ...
                <div className='tw-flex tw-gap-x-5'>
                    ...
                    <input type='tel' id='phonenumber' placeholder='1234 567890' className=' tw-w-full tw-p-[12px] tw-rounded-[8px] tw-shadow-sm tw-shadow-[#ffffffd9] tw-bg-richblack-800 tw-text-[16px] tw-text-richblack-200 tw-outline-none '  />
                </div>
            ...
            <div className='tw-grid tw-grid-cols-1 btnalign:tw-grid-cols-2 tw-gap-y-6 tw-gap-x-6 tw-justify-center '>
                <div className='tw-flex tw-flex-col tw-gap-y-3 tw-relative'>
                    ...
                    <input id='password' type={visible ? 'text' : 'password'} placeholder='Enter Password' className=' tw-p-[12px] tw-pr-[35px] tw-rounded-[8px] tw-shadow-sm tw-shadow-[#ffffffd9] tw-bg-richblack-800 tw-text-[16px] tw-text-richblack-200 tw-outline-none ' />
                ...
                <div className='tw-flex tw-flex-col tw-gap-y-3 tw-relative'>
                    ...
                    <input id='confirmpassword' type={visibleEye2 ? 'text' : 'password'} placeholder='Enter Password' className=' tw-p-[12px] tw-pr-[35px] tw-rounded-[8px] tw-shadow-sm tw-shadow-[#ffffffd9] tw-bg-richblack-800 tw-text-[16px] tw-text-richblack-200 tw-outline-none ' />
                    <span className='tw-w-[25px] tw-aspect-square tw-absolute tw-block tw-right-[3.5%]  tw-top-[55%] tw-ml-10'>
                        {
                            !visibleEye2 ?
