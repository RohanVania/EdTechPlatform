...
function AuthFormTemplate({ title, description1, description2, formtype }) {
    ...
    return (
            <div className={`2xs:tw-flex  tw-justify-evenly tw-flex-row-reverse tw-flex-wrap tw-space-y-[64px] tw-items-center  sm:tw-pb-[133px] ${ false? 'tw-blur-[5px]' : 'tw-blur-0'}`}>
