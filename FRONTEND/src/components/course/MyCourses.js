                ...
                <table className=" tw-w-full tw-py-3">
                    ...
                    <tbody className="">
                        <tr className="tw-flex xl:tw-flex-row tw-flex-col tw-flex-wrap tw-text-left tw-gap-x-2  tw-px-0 md:tw-px-2 ">
                            ...
                            {/* <td className="tw-flex-[0.1] tw-bg-purple-400 tw-py-3 tw-px-3 tw-flex tw-gap-x- tw-justify-around">

                                <FiEdit2 className="tw-text-[25px] tw-bg-red-400 tw-p-[2px] xl:tw-flex-1 tw-cursor-pointer" />
                                <MdDelete className="tw-text-[25px] tw-p-[2px] xl:tw-flex-1 tw-bg-red-800 tw-cursor-pointer" />
                            </td> */}
                        </tr>
