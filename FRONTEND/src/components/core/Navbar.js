...
function Navbar() {
    ...
    return (
        <>
            <div id='navbar' className='tw-bg-richblack-900  tw-min-h-[70px  tw-flex tw-items-center tw-border-b-[0.7px] tw-border-richblack-700 tw-fixed tw-top-0 tw-w-full tw-z-[999]'>
