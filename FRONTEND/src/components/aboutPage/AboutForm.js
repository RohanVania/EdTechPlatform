...
function AboutForm() {
    ...
    return (
        <form id='about_contact_form' className='tw-flex tw-flex-col tw-justify-center tw-px-3 tw-gap-y-7' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='tw-flex tw-flex-col tw-gap-y-2'>
                <label htmlFor='emailaddress' className=' tw-font-[400] tw-text-[15px]'>Email Address</label>
