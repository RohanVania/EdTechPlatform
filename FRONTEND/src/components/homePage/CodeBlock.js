        ...
        <div className={`tw-flex tw-flex-col tw-items-center codeblock:tw-flex-row  ${reversestyle}  tw-justify-evenly tw-gap-5 btnalign:tw-gap-9 `}>
            ...
            <div className='tw-w-full tw-bg-purple-40 tw-flex tw-flex-col tw-gap-5 xs:tw-gap-10 tw-py-5 xs:tw-py-9 sm:tw-max-w-[600px]'>
                <div className='tw-flex tw-flex-col tw-gap-4'>
                    ...
                    <p className='tw-text-richblack-300 tw-text-[10px] 3xs:tw-text-[13px] 2xs:tw-text-[15px] xs:tw-text-[17px] sm:tw-text-[17px] md:tw-text-[21px]  '>
                      {text}
                    </p>
                </div>
                <div className='tw-flex tw-gap-2 xs:tw-gap-5 '>
                    <Buttons btnobject={btnobj} extrasmall />
                </div>
            </div>
            {/* Block 2 */}
            <div className='tw-w-full tw-bg-purple-80  tw-flex tw-flex   sm:tw-max-w-[600px] codeblock:tw-h-[386px]  codeblock:tw-py-4'>
                
                <div className='tw-flex tw-items-center tw-justify-around tw-text-richblack-50 tw-whitespace-pre-line '>
                    <div className='tw-flex tw-flex-col tww-[12%] tw-text-[13px] 2xs:tw-text-[16px] xs:tw-text-[20px] tw-items-start '>
                        <p>1.</p>
                        <p>2.</p>
                        <p>3.</p>
                        <p>4.</p>
                    ...
                    <div className={`${codecolor} tw-w-full  tw-text-[12px] btn:tw-text-[12px] 2xs:tw-text-[15px] xs:tw-text-[20px] tw-flex-1  tw-h-[97%] tw-w-[100%] xs:tw-h-full codeblock:tw-h-[93.3%] `}>
                        <TypeAnimation
